...
window.Typekit.config = {
    "a": "646866",
    "dl": "AAAAVwAAAAp1mH3AUgugbgA9EOc",
    "fi": [5474, 175, 173, 139, 176, 140, 15530, 15528],
    "fc": [{
        "id": 5474,
        "family": "proxima-nova",
        "src": "https://use.typekit.net/af/cebe0e/00000000000000003b9b3060/27/{format}{?primer,subset_id,fvd,v}",
        "descriptors": {
            "weight": "300",
            "style": "normal",
            "display": "auto",
        ...
        "id": 175,
        "family": "proxima-nova",
        "src": "https://use.typekit.net/af/705e94/00000000000000003b9b3062/27/{format}{?primer,subset_id,fvd,v}",
        "descriptors": {
            "weight": "400",
            "style": "normal",
            "display": "auto",
        ...
        "id": 173,
        "family": "proxima-nova",
        "src": "https://use.typekit.net/af/576d53/00000000000000003b9b3066/27/{format}{?primer,subset_id,fvd,v}",
        "descriptors": {
            "weight": "600",
            "style": "normal",
            "display": "auto",
        ...
        "id": 139,
        "family": "proxima-nova",
        "src": "https://use.typekit.net/af/949f99/00000000000000003b9b3068/27/{format}{?primer,subset_id,fvd,v}",
        "descriptors": {
            "weight": "700",
            "style": "normal",
            "display": "auto",
        ...
        "id": 176,
        "family": "proxima-nova",
        "src": "https://use.typekit.net/af/5c70f2/00000000000000003b9b3063/27/{format}{?primer,subset_id,fvd,v}",
        "descriptors": {
            "weight": "400",
            "style": "italic",
            "display": "auto",
        ...
        "id": 140,
        "family": "proxima-nova",
        "src": "https://use.typekit.net/af/4c4052/00000000000000003b9b3069/27/{format}{?primer,subset_id,fvd,v}",
        "descriptors": {
            "weight": "700",
            "style": "italic",
            "display": "auto",
        ...
        "id": 15530,
        "family": "europa",
        "src": "https://use.typekit.net/af/4eabcf/00000000000000003b9b12fd/27/{format}{?primer,subset_id,fvd,v}",
        "descriptors": {
            "weight": "400",
            "style": "normal",
            "display": "auto",
        ...
        "id": 15528,
        "family": "europa",
        "src": "https://use.typekit.net/af/f3ba4f/00000000000000003b9b12fa/27/{format}{?primer,subset_id,fvd,v}",
        "descriptors": {
            "weight": "700",
            "style": "normal",
            "display": "auto",
    ...
    "fn": ["europa", ["n4", "n7"], "proxima-nova", ["i4", "i7", "n3", "n4", "n6", "n7"]],
    "hn": "use.typekit.net",
    "ht": "tk",
    "js": "1.20.0",
    "kt": "646866_5d0cbbde5ac0ce0001b4754c",
    "l": "typekit",
    "ps": 2,
...
/*{"k":"1.20.0","auto_updating":true,"last_published":"2019-11-12 05:59:51 UTC"}*/
;
(function (window, document, undefined) {
    ...
    Ha.prototype.load = function (a, b) {
        ...
        if (c.length)
            for (var e = this, f = c.length, g = 0; g < c.length; g++) Ia(this, c[g], function () {
                --f || Ja(e, d)
            });
        else Ja(this, d)
    };
    ...
    for (var V, m = window.Typekit.config || {}, La = [], Na = m.fc, Oa = 0; Oa < Na.length; Oa++) La.push(Na[Oa].id);
    V = new T(Ma);
    m.ping && (V.m = new Ka);
    m.vft && (V.o = m.vft);
    if (m.fc)
        for (var W = m.fc, X = 0; X < W.length; X++) {
            var Y = W[X].src,
                Pa = W[X].descriptors || {},
                Qa;
            if (Qa = V.o) null === Ea && (Ea = window.CSS && window.CSS.supports && CSS.supports("font-variation-settings", '"wght" 400')), Qa = Ea;
    ...
    m.token && (V.i = m.token);
    if (m.c)
        for (var n = 0; n < m.c.length; n += 2) V.g.push(new ea);
